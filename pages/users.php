...
<?php if ($success): ?><div class="alert-cv success"><i class="fas fa-check-circle me-2"></i><?php echo htmlspecialchars($success); ?></div><?php endif; ?>
<?php if ($error):   ?><div class="alert-cv danger"><i class="fas fa-exclamation-circle me-2"></i><?php echo htmlspecialchars($error); ?></div><?php endif; ?>
        ...
        <div class="page-card">
            ...
            <table class="table-cv">
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge-<?php echo $u['role']==='admin'?'pending':($u['role']==='institution'?'valid':'revoked'); ?>"
                              style="<?php echo $u['role']==='employer'?'background:#f0f0ff;color:#6b21a8;':''; ?>">
                            <?php echo ucfirst($u['role']); ?>
                        </span>
                    </td>
                    <td style="font-size:0.82rem;"><?php echo date('d M Y', strtotime($u['dateCreated'])); ?></td>
                    <td>
                    ...
                    <td>
                        ...
                        <form method="POST" style="display:inline;">
                            ...
                            <input type="hidden" name="newStatus" value="<?php echo $u['status']==='active'?'inactive':'active'; ?>">
                            <button type="submit"
